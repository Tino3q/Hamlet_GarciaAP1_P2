...
namespace Hamlet_GarciaAP1_P2.Migrations
{
    ...
    [Migration("20260310023427_inicial2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hamlet_GarciaAP1_P2.Models.AsignacionesPuntos", b =>
                {
            ...
            modelBuilder.Entity("Hamlet_GarciaAP1_P2.Models.DetalleAsignacion", b =>
                {
                    ...
                    b.HasIndex("TipoPuntoId");

                    b.ToTable("DetalleAsignacion");
                });

            modelBuilder.Entity("Hamlet_GarciaAP1_P2.Models.Estudiantes", b =>
                {
                    b.Property<int>("EstudianteId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hamlet_GarciaAP1_P2.Models.TiposPuntos", b =>
                {
            ...
            modelBuilder.Entity("Hamlet_GarciaAP1_P2.Models.AsignacionesPuntos", b =>
                {
                    b.HasOne("Hamlet_GarciaAP1_P2.Models.Estudiantes", "Estudiante")
                        .WithMany()
            ...
            modelBuilder.Entity("Hamlet_GarciaAP1_P2.Models.DetalleAsignacion", b =>
                {
                    b.HasOne("Hamlet_GarciaAP1_P2.Models.AsignacionesPuntos", "Asignacion")
                        .WithMany("Detalle")
                        .HasForeignKey("IdAsignacion")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Hamlet_GarciaAP1_P2.Models.TiposPuntos", "TipoPunto")
                        .WithMany()
                        .HasForeignKey("TipoPuntoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Asignacion");

                    b.Navigation("TipoPunto");
                });
